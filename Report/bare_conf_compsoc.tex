...
%Future Work
\section{Future Work}
First, the high I/O latency can be solved by using audio device with low latency and raise the audio I/O device priority in operating system.
\par
Next, in order to lower the processing time. Instead of using MATLAB code,  high-efficient programming language like C or Assembly can be used to achieve that.
